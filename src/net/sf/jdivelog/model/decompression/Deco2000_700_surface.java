...
public class Deco2000_700_surface implements DecompressionTable {
    ...
    /**
     * Return the time without any decompression
     * @return the decompression in the security profile
     */
    ...
    public void initialize(Integer depth, Integer duration, String repeat_group, Integer surface_interval, Double o2_ratio, Integer down_dive_speed) {
        ...
        setDuration(duration + add_dive_time + new Integer(java.lang.Math.round(calculated_depth_higher / down_dive_speed)));
    ...
    /**
     * Get the time to add to the real dive time to calculate the decompression after a
     * first dive
     * @param repeating_group: The group after the first dive
     * @param surface_interval: The surface time between dives
     * @return the time for majoration
     */
     ...
     */
    public JComponent getConfigurationPanel(MainWindow mainWindow) {
        if (configurationPanel == null) {
            configurationPanel = new JScrollPane(new Deco2000_ConfigurationPanel(mainWindow));
        }
    ...
    /**
     * 
     * Class for the configuration panel
     *
     */
...
/**
 * Constructor
 * @param mainWindow: the window in which include the panel
 */
        ...
        /**
         * Text field for the maximum depth
        ...
        /**
         * Text field for the air consumption
         * @return the JTextField containing the information
         */
        ...
        /**
         * To get the speed from bottom to the surface 
         * @return the speed
         */
        ...
        /**
         * To get the speed from surface to bottom
         * @return the JTExtField with down speed
         */
        ...
        /**
         * The Area with the dive data
         * @return the JTextArea with the dive data
         */
        ...
        /**
         * The button in order to launch the calculate of the decompression model
        ...
        /**
         * The text field for the surface time
         * @return the JTextField containing the information
         */
        ...
        /**
         * Combo box to set the repeating group after the first dive
         * @return the JComboBox with the information
         */
        ...
        /**
         * Panel with the profile
         * @return the panel where is drawn the panel
         */
        ...
        /**
         * 
         * @param data_xy the points
         * @return the chart with the profile
         */
        ...
        /**
         * Collection of points defined as (x,y)
         * @return
         */
        private XYSeriesCollection diveProfile_data() {
            ...
            series.add(0, 0);
            // down dive
            temp = new Double(deco2000_700_surface.depth) / new Double(down_dive_speed.getText());
            series.add(temp.doubleValue(), -1 * deco2000_700_surface.depth);
            airconsumption = amv * temp.doubleValue() * ((deco2000_700_surface.depth / 10) + 1);
            // dive time at the ground
            temp += deco2000_700_surface.duration;
            series.add(temp.doubleValue(), -1 * deco2000_700_surface.depth);
            airconsumption += amv * temp.doubleValue() * ((deco2000_700_surface.depth / 10) + 1);
            // up dive time with stops
            temp_up_dive_time -= temp;
            if (deco2000_700_surface.getDecompressionStops() != null) {
                if (deco2000_700_surface.getDecompressionStops().get(15) != null) {
                    temp += (new Double(deco2000_700_surface.depth - 15) / new Double(up_dive_speed.getText()));
                    series.add(temp.doubleValue(), -15);
                    airconsumption += amv * (new Double(deco2000_700_surface.depth - 15) / new Double(up_dive_speed.getText())) * 2.5;
                    temp += deco2000_700_surface.getDecompressionStops().get(15);
                    series.add(temp.doubleValue(), -15);
                    airconsumption += amv * deco2000_700_surface.getDecompressionStops().get(15) * 2.5;
                }
                if (deco2000_700_surface.getDecompressionStops().get(12) != null) {
                    if (deco2000_700_surface.getDecompressionStops().get(15) == null) {
                        temp += (new Double(deco2000_700_surface.depth - 12) / new Double(up_dive_speed.getText()));
                        airconsumption += amv * (new Double(deco2000_700_surface.depth - 12) / new Double(up_dive_speed.getText())) * 2.5;
                    } else {
                    ...
                    temp += deco2000_700_surface.getDecompressionStops().get(12);
                    series.add(temp.doubleValue(), -12);
                    airconsumption += amv * deco2000_700_surface.getDecompressionStops().get(12) * 2.2;
                }
                if (deco2000_700_surface.getDecompressionStops().get(9) != null) {
                    if (deco2000_700_surface.getDecompressionStops().get(12) == null) {
                        temp += (new Double(deco2000_700_surface.depth - 9) / new Double(up_dive_speed.getText()));
                        airconsumption += amv * (new Double(deco2000_700_surface.depth - 9) / new Double(up_dive_speed.getText())) * 1.9;
                    } else {
                        temp += (new Double(3) / new Double(up_dive_speed.getText()));
                        airconsumption += amv * (new Double(3) / new Double(up_dive_speed.getText())) * 1.9;
                    }
                    series.add(temp.doubleValue(), -9);
                    temp += deco2000_700_surface.getDecompressionStops().get(9);
                    series.add(temp.doubleValue(), -9);
                    airconsumption += amv * deco2000_700_surface.getDecompressionStops().get(9) * 1.9;
                }
                if (deco2000_700_surface.getDecompressionStops().get(6) != null) {
                    if (deco2000_700_surface.getDecompressionStops().get(9) == null) {
                        temp += (new Double(deco2000_700_surface.depth - 6) / new Double(up_dive_speed.getText()));
                        airconsumption += amv * (new Double(deco2000_700_surface.depth - 6) / new Double(up_dive_speed.getText())) * 1.6;
                    } else {
                        temp += (new Double(3) / new Double(up_dive_speed.getText()));
                        airconsumption += amv * (new Double(3) / new Double(up_dive_speed.getText())) * 1.6;
                    }
                    series.add(temp.doubleValue(), -6);
                    temp += deco2000_700_surface.getDecompressionStops().get(6);
                    series.add(temp.doubleValue(), -6);
                    airconsumption += amv * deco2000_700_surface.getDecompressionStops().get(6) * 1.6;
                }
                if (deco2000_700_surface.getDecompressionStops().get(3) != null) {
                    if (deco2000_700_surface.getDecompressionStops().get(6) == null) {
                        temp += (new Double(deco2000_700_surface.depth - 3) / new Double(up_dive_speed.getText()));
                        airconsumption += amv * (new Double(deco2000_700_surface.depth - 3) / new Double(up_dive_speed.getText())) * 1.3;
                    } else {
                        temp += (new Double(3) / new Double(up_dive_speed.getText()));
                        airconsumption += amv * (new Double(3) / new Double(up_dive_speed.getText())) * 1.3;
                    }
                    series.add(temp.doubleValue(), -3);
                    temp += deco2000_700_surface.getDecompressionStops().get(3);
                    series.add(temp.doubleValue(), -3);
                    airconsumption += amv * deco2000_700_surface.getDecompressionStops().get(3) * 1.3;
                }
                // the surface
                temp += (new Double(3) / new Double(up_dive_speed.getText()));
                airconsumption += amv * (new Double(3) / new Double(up_dive_speed.getText())) * 1.3;
            } else {
                temp += (new Double(deco2000_700_surface.depth) / new Double(up_dive_speed.getText()));
                airconsumption += amv * (new Double(deco2000_700_surface.depth) / new Double(up_dive_speed.getText())) * 1.3;
            }
            temp_up_dive_time += temp;
            series.add(temp.doubleValue(), 0);

            // set the complete_duration and up dive duration
            deco2000_700_surface.setComplete_duration(temp);
            deco2000_700_surface.setComplete_up_dive_duration(temp_up_dive_time);
         ...
         * @return the tank volume needed
         */
        private Integer getTankVolume() {
            if (airconsumption <= 1120) {
                return 7;
            } else if (airconsumption <= 1280) {
                return 8;
            } else if (airconsumption <= 1600) {
                return 10;
            } else if (airconsumption <= 1920) {
                return 12;
            } else if (airconsumption <= 2240) {
                return 14;
            } else if (airconsumption <= 2400) {
                return 15;
            } else if (airconsumption <= 2560) {
                return 16;
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == calculateButton) {
                ...
                if (repeating_groups.getSelectedIndex() != -1 && !surface_time.getText().trim().equals("")) {
                    deco2000_700_surface.initialize(new Integer(getMax_depth().getText()), new Integer(getDuration().getText()), (String) repeating_groups
                            .getSelectedItem(), new Integer(surface_time.getText()), new Double(o2_ratio.getText()), new Integer(down_dive_speed.getText()));
                } else {
                    deco2000_700_surface.initialize(new Integer(getMax_depth().getText()), new Integer(getDuration().getText()), "", 0, new Double(o2_ratio.getText()), new Integer(down_dive_speed.getText()));
                }

                if (repeating_groups.getSelectedIndex() != -1 && !surface_time.getText().trim().equals("")) {
                    divedata += Messages.getString("diveplanning.repeat_dive") + "\n";
                    divedata += Messages.getString("diveplanning.add_on_time") + ": \t" + deco2000_700_surface.getAdd_dive_time() + "\n";
                    divedata += "======================================================================================\n";
                }
                ...
                setDiveProfile();
                // calculate cns
                Double ppo = NitroxCalculationUtil.calculatePPO(deco2000_700_surface.getDepth().doubleValue(), new Double(o2_ratio.getText()));
                Double singleCNS = null;
                Double dailyCNS = null;
                if (ppo <= 1.6) {
                    singleCNS = NitroxCalculationUtil.getSingleDiveCNS(ppo, deco2000_700_surface.getDuration().doubleValue());
                    dailyCNS = NitroxCalculationUtil.getDailyCNS(ppo, deco2000_700_surface.getDuration().doubleValue());
                    if (deco2000_700_surface.getDecompressionStops() != null) {
                        Iterator<Integer> it = deco2000_700_surface.getDecompressionStops().keySet().iterator();
                        while (it.hasNext()) {
                            Integer depth = it.next();
                            Integer duration = deco2000_700_surface.getDecompressionStops().get(depth);
                ...
                divedata += Messages.getString("diveplanning.zerohour") + ": \t" + deco2000_700_surface.getZeroHour() + " ";
                divedata += Messages.getString("minutes") + "\t";
                divedata += Messages.getString("diveplanning.repeating_group") + ": \t" + (deco2000_700_surface.getRepeatGroup()==null?"":deco2000_700_surface.getRepeatGroup()) + "\t";
                divedata += Messages.getString("diveplanning.no_flight") + ": \t" + (deco2000_700_surface.no_flight.get(deco2000_700_surface.getRepeatGroup())==null?"":deco2000_700_surface.no_flight.get(deco2000_700_surface.getRepeatGroup())
                        + " [h]") + "\n";
                divedata += Messages.getString("diveplanning.complete_duration") + ": \t" + Math.round(deco2000_700_surface.getComplete_duration()) + " ["
                        + UnitConverter.getDisplayTimeUnit() + "]\t";
                divedata += Messages.getString("diveplanning.complete_up_dive_duration") + ": \t\t"
                        + Math.round(deco2000_700_surface.getComplete_up_dive_duration()) + " [" + UnitConverter.getDisplayTimeUnit() + "]\n";
                divedata += Messages.getString("diveplanning.air_consumption") + ": \t" + Math.round(airconsumption) + " [bar l]\t"
                        ...
                        + "]\t";
                divedata += Messages.getString("diveplanning.ead") + ": \t" + Math.round(NitroxCalculationUtil.calculateEAD(deco2000_700_surface.getDepth().doubleValue(), new Double(o2_ratio.getText()))) + " ["
                ...
                if (deco2000_700_surface.getDecompressionStops() == null
                        && (deco2000_700_surface.getZeroHour() == null || deco2000_700_surface.getZeroHour() < new Integer(getDuration().getText()))
                        || deco2000_700_surface.getDecompressionStops() != null
                        && (deco2000_700_surface.getDecompressionStops().get(3) == null && deco2000_700_surface.getZeroHour() < new Integer(getDuration()
                                .getText()))) {
                    ...
                    if (deco2000_700_surface.getDecompressionStops() != null && deco2000_700_surface.getDecompressionStops().get(3) != null) {
                        divedata += Messages.getString("diveplanning.duration_on_3m") + ": \t";
                        divedata += deco2000_700_surface.getDecompressionStops().get(3) + " ";
                        divedata += Messages.getString("minutes") + "\n";
                    }
                    if (deco2000_700_surface.getDecompressionStops() != null && deco2000_700_surface.getDecompressionStops().get(6) != null) {
                        divedata += Messages.getString("diveplanning.duration_on_6m") + ": \t";
                        divedata += deco2000_700_surface.getDecompressionStops().get(6) + " ";
                        divedata += Messages.getString("minutes") + "\n";
                    }
                    if (deco2000_700_surface.getDecompressionStops() != null && deco2000_700_surface.getDecompressionStops().get(9) != null) {
                        divedata += Messages.getString("diveplanning.duration_on_9m") + ": \t";
                        divedata += deco2000_700_surface.getDecompressionStops().get(9) + " ";
                        divedata += Messages.getString("minutes") + "\n";
                    }
                    if (deco2000_700_surface.getDecompressionStops() != null && deco2000_700_surface.getDecompressionStops().get(12) != null) {
                        divedata += Messages.getString("diveplanning.duration_on_12m") + ": \t";
                        divedata += deco2000_700_surface.getDecompressionStops().get(12) + " ";
                        divedata += Messages.getString("minutes") + "\n";
                    }
                    if (deco2000_700_surface.getDecompressionStops() != null && deco2000_700_surface.getDecompressionStops().get(15) != null) {
                        divedata += Messages.getString("diveplanning.duration_on_15m") + ": \t";
                        divedata += deco2000_700_surface.getDecompressionStops().get(15) + " ";
                        divedata += Messages.getString("minutes") + "\n";
                    }
    ...
    /**
     * Get full dive time, from surface to surface
    ...
    /**
     * Set the complete duration
     * @param complete_duration
     */
    ...
    /**
     * Get the time from bottom to surface
     * @return the up time
     */
    ...
    /**
     * Defines the time from bottom to surface
    ...
    /**
     * The time to add to the real dive time
