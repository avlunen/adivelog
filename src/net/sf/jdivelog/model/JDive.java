...
public class JDive implements Comparable<JDive> {
    ...
    public void write(Appendable sb) throws IOException {
        ...
        sb.append("<DiveNum>");
        if (diveNumber != null) {
            sb.append(String.valueOf(diveNumber));
        }
        sb.append("</DiveNum>");
        sb.append("<UNITS>");
        sb.append(units);
        sb.append("</UNITS>");
        sb.append("<DATE><YEAR>");
        if (gc != null) sb.append(String.valueOf(gc.get(Calendar.YEAR)));
        sb.append("</YEAR><MONTH>");
        if (gc != null) sb.append(String.valueOf(gc.get(Calendar.MONTH)+1));
        sb.append("</MONTH><DAY>");
        if (gc != null) sb.append(String.valueOf(gc.get(Calendar.DAY_OF_MONTH)));
        sb.append("</DAY></DATE>");
        sb.append("<TIME><HOUR>");
        if (gc != null) sb.append(String.valueOf(gc.get(Calendar.HOUR_OF_DAY)));
        sb.append("</HOUR><MINUTE>");
        if (gc != null) sb.append(String.valueOf(gc.get(Calendar.MINUTE)));
        ...
        sb.append(String.valueOf(htmlExported));
        sb.append("</htmlExported>");
        sb.append("<amv>");
        if (amv != null) sb.append(String.valueOf(amv));
        sb.append("</amv>");
        sb.append("<Depth>");
        if (depth != null) sb.append(String.valueOf(depth));
        sb.append("</Depth>");
        sb.append("<Average_Depth>");
        if (average_depth != null) sb.append(String.valueOf(average_depth));
        sb.append("</Average_Depth>");
        sb.append("<Duration>");
        if (duration != null) sb.append(String.valueOf(duration));
        sb.append("</Duration>");
        sb.append("<Visibility>");
        if (visibility != null) sb.append(XmlTextEncodingUtil.xmlEntityConvert(visibility));
        sb.append("</Visibility>");
        sb.append("<TEMPERATURE>");
        if (temperature != null) sb.append(String.valueOf(temperature));
        sb.append("</TEMPERATURE>");
        sb.append("<surfaceTemperature>");
        if (surfaceTemperature != null) sb.append(String.valueOf(surfaceTemperature));
        sb.append("</surfaceTemperature>");
        sb.append("<Buddy>");
