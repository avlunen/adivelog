 ...
 * href="http://diversity.sourceforge.net/uwatec_smart_format.html">Uwatec Smart
 * Dive Computer Data Format &amp; Protocol</a>
 * 
...
public class SmartData {
    ...
    private void parseData(byte[] read_data) {
        ...
        do {
            ...
            } else if (computerType == SmartComputerType.GALILEO_SOL) {
                log = new GalileoSolLogEntry(read_data, offset);
            } else {
                throw new IllegalArgumentException("computer model \""
                        + computerType + "\" not supported yet");
            }
            logbook.add(log);
