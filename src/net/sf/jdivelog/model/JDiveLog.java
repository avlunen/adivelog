...
public class JDiveLog {
   ...
   public BigDecimal getMinTemperature() {
      BigDecimal minTemperature = new BigDecimal(100); // set to 100, rather than 0, otherwise no minimum will ever be
                                                       // found
   ...
   /**
    * @param gasBlendingSettings The gasBlendingSettings to set.
    */
   ...
   /**
    * @param gasOverflowSettings The gasOverflowSettings to set.
    */
   ...
   public void assemblyDives(TreeSet<JDive> selectedDives) {
      ...
      JDive firstDive = it.next(); // TODO modernize
      ...
      while (it.hasNext()) {
         ...
         if (firstDive.getTemperature() != null && dive.getTemperature() != null
               && (firstDive.getTemperature() > dive.getTemperature())) {
