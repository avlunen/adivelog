 ...
 * 
 */
public class Uddf310DigesterConfigurator extends UddfDigesterConfigurator {
	...
	private void configureProfileData(Digester d) {
		...
		d.addCallMethod(DIVE_PATTERN + SEPARATOR + "informationbeforedive" + SEPARATOR + "datetime", "setDatetime", 1);
		d.addCallParam(DIVE_PATTERN + SEPARATOR + "informationbeforedive" + SEPARATOR + "datetime", 0);
        ...
        d.addCallMethod(DIVE_PATTERN + SEPARATOR + "informationafterdive" + SEPARATOR + "greatestdepth", "setGreatestdepth", 1);
        d.addCallParam(DIVE_PATTERN + SEPARATOR + "informationafterdive" + SEPARATOR + "greatestdepth",0);
        d.addCallMethod(DIVE_PATTERN + SEPARATOR + "informationafterdive" + SEPARATOR + "lowesttemperature", "setLowesttemperature", 1);
        d.addCallParam(DIVE_PATTERN + SEPARATOR + "informationafterdive" + SEPARATOR + "lowesttemperature", 0);
		configureSamples(d);
	...
	private void configureSamples(Digester d) {
        ...
        d.addCallMethod(WAYPOINT_PATTERN + SEPARATOR + "measuredpo2", "setMeasuredpo2", 2);
        d.addCallParam(WAYPOINT_PATTERN + SEPARATOR + "measuredpo2", 0, "ref");
        d.addCallParam(WAYPOINT_PATTERN + SEPARATOR + "measuredpo2", 1);
