...
/**
 * Description: Informations about tanks with volume, pressure start and end,
 * mix,...
 * 
 * @author Pascal Pellmont <jdivelog@pellmont.dyndns.org>
 * 
 ...
 * @version 1.1
 * 
 *          Updated to set default values (Air), otherwise there is a chance of
 *          an exception thrown down the line
 */
public class Gas {
    ...
    * 
    * @param helium The percentage of helium.
    */
   ...
   public void setHelium(String helium) {
      if (helium == null || "".equals(helium.trim())) {
         ...
         this.helium = Double.valueOf(helium);
      }
   }
    ...
    * 
    * @param nitrogen The percentage of nitrogen.
    */
   ...
   /**
    * Sets the percentage of nitrogen. 1.0 would be 100% nitrogen. Method used by
    * digester.
    * 
    * @param nitrogen The percentage of nitrogen.
    */
    ...
    * digester.
    * 
    * @param oxygen The percentage of oxygen.
    */
   ...
   public void setOxygen(String oxygen) {
      if (oxygen == null || "".equals(oxygen.trim())) {
         ...
         this.oxygen = Double.valueOf(oxygen);
      }
   }
    ...
    * 
    * @param pend The pressure at the end of the dive.
    */
    ...
    * 
    * @param pstart The pressure at the beginning of the dive.
    */
   ...
   public void setPstart(String pstart) {
      if (pstart == null || "".equals(pstart.trim())) {
         ...
         this.pstart = Double.valueOf(pstart);
      }
   }
    ...
    * Sets the tankvolume.
    * 
    * @param tankvolume The tankvolume.
    */
   ...
   public void setTankvolume(String tankvolume) {
      if (tankvolume == null || "".equals(tankvolume.trim())) {
         ...
         this.tankvolume = Double.valueOf(tankvolume);
      }
   }
