...
public class Dive implements Comparable<Dive> {
   ...
   public void addCns(String value) {
      Cns cns = new Cns();
      cns.setValue(Double.valueOf(value));
      addSample(cns);
   }

   public void addDelta(String value) {
      Delta delta = new Delta();
      delta.setValue(Double.valueOf(value));
      addSample(delta);
   }
   ...
   public void addSetpointSwitch(String value) {
      SetpointSwitch s = new SetpointSwitch();
   ...
   public void addDecoInfo(String depth, String tfs, String tts) {
      ...
      if (tfs != null && !"".equals(tfs)) {
         d.setTfs(Double.valueOf(tfs));
      }
      if (tts != null && !"".equals(tts)) {
         d.setTts(Double.valueOf(tts));
      }
      addSample(d);
   }
   ...
   public void write(Appendable sb) throws IOException {
      ...
      sb.append("<DIVE>");
      sb.append("<DATE><YEAR>");
      sb.append(String.valueOf(gc.get(Calendar.YEAR)));
      sb.append("</YEAR><MONTH>");
      sb.append(String.valueOf(gc.get(Calendar.MONTH) + 1));
      sb.append("</MONTH><DAY>");
      sb.append(String.valueOf(gc.get(Calendar.DAY_OF_MONTH)));
      sb.append("</DAY></DATE>");
      sb.append("<TIME><HOUR>");
      sb.append(String.valueOf(gc.get(Calendar.HOUR_OF_DAY)));
   ...
   public Double getMaxDepth() {
      ...
      for(Object o : getSamples()) {
         if (o instanceof Depth) {
            ...
            if (val != null) {
               if (max == null || max.doubleValue() < val.doubleValue()) {
                  max = val;
               }
            }
         }
