...
public class UdcfFileLoader {
    ...
    public UdcfFileLoader(File f) throws SAXException, IOException {
        this.file = f;
        Digester d = new CaseIgnoreDigester();
        ...
        d.addObjectCreate("PROFILE/REPGROUP/DIVE/MIX", Gas.class);
        d.addCallMethod("PROFILE/REPGROUP/DIVE/MIX/MIXNAME", "setName", 1);
        d.addCallParam("PROFILE/REPGROUP/DIVE/MIX/MIXNAME", 0);
        d.addCallMethod("PROFILE/REPGROUP/DIVE/MIX/TANK/TANKVOLUME", "setTankvolume", 1);
        d.addCallParam("PROFILE/REPGROUP/DIVE/MIX/TANK/TANKVOLUME", 0);
        d.addCallMethod("PROFILE/REPGROUP/DIVE/MIX/TANK/PSTART", "setPstart", 1);
        d.addCallParam("PROFILE/REPGROUP/DIVE/MIX/TANK/PSTART", 0);
        d.addCallMethod("PROFILE/REPGROUP/DIVE/MIX/TANK/PEND", "setPend", 1);
        d.addCallParam("PROFILE/REPGROUP/DIVE/MIX/TANK/PEND", 0);
        d.addCallMethod("PROFILE/REPGROUP/DIVE/MIX/O2", "setOxygen", 1);
        d.addCallParam("PROFILE/REPGROUP/DIVE/MIX/O2", 0);
        d.addCallMethod("PROFILE/REPGROUP/DIVE/MIX/N2", "setNitrogen", 1);
        d.addCallParam("PROFILE/REPGROUP/DIVE/MIX/N2", 0);
        d.addCallMethod("PROFILE/REPGROUP/DIVE/MIX/HE", "setHelium", 1);
        d.addCallParam("PROFILE/REPGROUP/DIVE/MIX/HE", 0);
        d.addSetNext("PROFILE/REPGROUP/DIVE/MIX", "addGas");
        d.addCallMethod("PROFILE/REPGROUP/DIVE/TIMEDEPTHMODE", "setTimeDepthMode");
        d.addCallMethod("PROFILE/REPGROUP/DIVE/DEPTHMODE", "setDeltaMode");
        ...
        while (it.hasNext()) {
            Dive dive = it.next();
            fixDelta(udcf.getUnits(), dive);
            jDives.add(new JDive(udcf.getUnits(), dive));
        }
    }

    private void fixDelta(String units, Dive dive) {
        if (!"si".equals(units)) {
            ArrayList<Sample> samples = dive.getSamples();
            for (Sample sample : samples) {
                if (sample instanceof Delta) {
                    Delta d = (Delta) sample;
                    d.setValue(d.getValue() / 60.0);
                }
            }
        }
    }
