...
public class CommandLoadFile implements Command {
    ...
    public void execute() {
        try {
            ...
            try {
                d.setFeature("http://apache.org/xml/features/allow-java-encodings", true);
            } catch (ParserConfigurationException e) {
                // tried it, but never mind
            }
    ...
    private class FileLoader2_13 implements FileLoader {
        public JDiveLog loadFile(File file) throws SAXException, IOException {
            ...
            d.addObjectCreate("JDiveLog/Dr5Settings", Dr5Settings.class);
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/flipScreen");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/flipScreenNextStart");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/brightMin");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/brightMax");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/defaultView", "defaultViewString");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/defaultCcrView", "defaultCcrViewString");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/defaultViewFallback");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/mode", "modeString");
            d.addCallMethod("JDiveLog/Dr5Settings/mixes/Mix", "addMix", 6, new Class[] {String.class, Integer.class, Integer.class, Double.class, Integer.class, Double.class});
            d.addCallParam("JDiveLog/Dr5Settings/mixes/Mix", 0, "name");
            d.addCallParam("JDiveLog/Dr5Settings/mixes/Mix", 1, "oxygen");
            d.addCallParam("JDiveLog/Dr5Settings/mixes/Mix", 2, "helium");
            d.addCallParam("JDiveLog/Dr5Settings/mixes/Mix", 3, "ppO2");
            d.addCallParam("JDiveLog/Dr5Settings/mixes/Mix", 4, "mod");
            d.addCallParam("JDiveLog/Dr5Settings/mixes/Mix", 5, "change");
            d.addObjectCreate("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann", Dr5SettingsBuehlmann.class);
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann/desaturationMultiplier");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann/saturationMultiplier");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann/normalGfLo");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann/normalGfHi");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann/emergencyGfLo");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann/emergencyGfHi");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann/gfLoPosMin");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann/gfLoPosMax");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann/lastStop");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann/safetyDistanceDecoStop");
            d.addSetNext("JDiveLog/Dr5Settings/Dr5SettingsBuehlmann", "setBuehlmann");
            d.addBeanPropertySetter("JDiveLog/Dr5Settings/Dr5SettingsOxygenDump", "oxygenDumpString");
            d.addSetNext("JDiveLog/Dr5Settings", "setDr5Settings");
            d.addBeanPropertySetter("JDiveLog/dr5Directory");
            ...
            d.addCallMethod("JDiveLog/IgnoredDives/JDive/DIVE/SAMPLES/SWITCH", "addSwitch", 1); //$NON-NLS-1$ //$NON-NLS-2$
            d.addCallParam("JDiveLog/IgnoredDives/JDive/DIVE/SAMPLES/SWITCH", 0); //$NON-NLS-1$
            d.addCallMethod("JDiveLog/IgnoredDives/JDive/DIVE/SAMPLES/SPSWITCH", "addSetpointSwitch", 1); //$NON-NLS-1$ //$NON-NLS-2$
            d.addCallParam("JDiveLog/IgnoredDives/JDive/DIVE/SAMPLES/SPSWITCH", 0); //$NON-NLS-1$
            d.addCallMethod("JDiveLog/IgnoredDives/JDive/DIVE/SAMPLES/T", "addTime", 1); //$NON-NLS-1$ //$NON-NLS-2$
            d.addCallParam("JDiveLog/IgnoredDives/JDive/DIVE/SAMPLES/T", 0); //$NON-NLS-1$
            d.addCallMethod("JDiveLog/IgnoredDives/JDive/DIVE/SAMPLES/D", "addDepth", 1); //$NON-NLS-1$ //$NON-NLS-2$
            d.addCallParam("JDiveLog/IgnoredDives/JDive/DIVE/SAMPLES/D", 0); //$NON-NLS-1$
