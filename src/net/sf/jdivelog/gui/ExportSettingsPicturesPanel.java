...
public class ExportSettingsPicturesPanel extends AbstractSettingsPanel {
    ...
    private class CommandSave implements UndoableCommand {
        ...
        public void execute() {
            ...
            newPictureImageMaxWidth = Integer.valueOf(getImageMaxWidthField().getText());
            newPictureImageMaxHeight = Integer.valueOf(getImageMaxHeightField().getText());
            newPictureThumbMaxWidth = Integer.valueOf(getThumbnailMaxWidthField().getText());
            newPictureThumbMaxHeight = Integer.valueOf(getThumbnailMaxHeightField().getText());
