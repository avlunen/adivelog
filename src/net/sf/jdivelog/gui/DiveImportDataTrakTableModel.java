...
public class DiveImportDataTrakTableModel extends AbstractTableModel {
    ...
    public DiveImportDataTrakTableModel(Masterdata masterdata,
            ArrayList<JDive> divesToAdd) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        UnitConverter c = new UnitConverter(UnitConverter.getSystem(dive
                .getUnits()), UnitConverter.getDisplaySystem());
        switch (columnIndex) {
        case 0:
            return dive.getDate() == null ? null : DateFormatUtil
                    .getDateTimeFormat().format(dive.getDate());
        case 1:
            return masterdata.getDiveSite(dive) == null ? null : masterdata
                    .getDiveSite(dive).getSpot();
        case 2:
            return masterdata.getDiveSite(dive) == null ? null : masterdata
                    .getDiveSite(dive).getCountry();
        case 3:
