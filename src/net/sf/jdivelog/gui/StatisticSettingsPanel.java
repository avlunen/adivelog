...
public class StatisticSettingsPanel extends AbstractSettingsPanel {
   ...
   // private static final String[] STATISTIC_TYPES = { StatisticPanel.TYPE_BAR,
   // StatisticPanel.TYPE_BAR3D, StatisticPanel.TYPE_PIE, StatisticPanel.TYPE_PIE3D
   // };
   private static final String[] STATISTIC_TYPES = { StatisticPanel.TYPE_BAR, StatisticPanel.TYPE_PIE };
   private static final String[] STATISTIC_ORIENTATIONS = { StatisticPanel.ORIENTATION_HORIZONTAL,
         StatisticPanel.ORIENTATION_VERTICAL };
   ...
   private class CommandSave implements UndoableCommand {
      ...
      public void execute() {
         ...
         newSettings.getDivePlaceStatistic()
               .setOrientation(divePlaceStatisticOrientationField.getSelectedItem().toString());
         newSettings.getCountryStatistic().setType(countryStatisticTypeField.getSelectedItem().toString());
         newSettings.getCountryStatistic()
               .setOrientation(countryStatisticOrientationField.getSelectedItem().toString());
         newSettings.getDiveTypeStatistic().setType(diveTypeStatisticTypeField.getSelectedItem().toString());
         newSettings.getDiveTypeStatistic()
               .setOrientation(diveTypeStatisticOrientationField.getSelectedItem().toString());
         newSettings.getDiveActivityStatistic().setType(diveActivityStatisticTypeField.getSelectedItem().toString());
         newSettings.getDiveActivityStatistic()
               .setOrientation(diveActivityStatisticOrientationField.getSelectedItem().toString());
