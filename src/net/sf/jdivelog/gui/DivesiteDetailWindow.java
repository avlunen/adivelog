...
public class DivesiteDetailWindow extends JDialog implements ActionListener {
    ...
    private TraversableJTextArea areaDescription;
    
    private TraversableJTextArea areaWarnings;
    
    private TraversableJTextArea areaDirections;

    private TraversableJTextArea areaPrivateRemarks;
    ...
    public DivesiteDetailWindow(Window parent, MainWindow mainWindow) {
    	this(parent, mainWindow, null,null);
    }
    ...
    public DivesiteDetailWindow(Window parent, MainWindow mainWindow, DiveSite site) {
    	this(parent, mainWindow, null, site);
    }
    ...
    /**
     * Create the JTextAreaNoTab for the private remarks
     * 
     * @return JTextAreaNoTab
     */
    private TraversableJTextArea getAreaPrivateRemarks() {
        if (areaPrivateRemarks == null) {
            areaPrivateRemarks = new TraversableJTextArea(400, 200);
    ...
    /**
     * Create the JTextAreaNoTab for the site description
     * 
     * @return JTextAreaNoTab
     */
    private TraversableJTextArea getAreaDescription() {
        if (areaDescription == null) {
            areaDescription = new TraversableJTextArea(400, 200);
    ...
    /**
     * Create the JTextAreaNoTab for the site warnings
     * 
     * @return JTextAreaNoTab
     */
    private TraversableJTextArea getAreaWarnings() {
        if (areaWarnings == null) {
            areaWarnings = new TraversableJTextArea(400, 200);
    ...
    /**
     * Create the JTextAreaNoTab for the driving directions
     * 
     * @return JTextAreaNoTab
     */
    private TraversableJTextArea getAreaDirections() {
        if (areaDirections == null) {
            areaDirections = new TraversableJTextArea(400, 200);
