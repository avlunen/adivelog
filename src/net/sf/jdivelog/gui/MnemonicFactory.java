...
public class MnemonicFactory {
	...
	private final MnemonicFinder[] finders = {
			new FirstCharacterMnemonicFinder(), new UpperCaseMnemonicFinder(),
			new LetterOrDigitMnemonicFinder(), };
	...
	private abstract class AbstactEarliestMatchMnemonicFinder implements
			MnemonicFinder {
		public int apply(String text) {
	...
	private class UpperCaseMnemonicFinder extends
			AbstactEarliestMatchMnemonicFinder {
		protected boolean matches(char c) {
			return Character.isUpperCase(c);
		}
	}

	private class LetterOrDigitMnemonicFinder extends
			AbstactEarliestMatchMnemonicFinder {
		protected boolean matches(char c) {
