...
public class ImportTableModel extends AbstractTableModel {
    ...
    private Set <JDive> jDives = null;
    
    public ImportTableModel(Set <JDive> jDives) {
        this.jDives = jDives;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
        	case 0: return dive.getDate() == null ? "" : DateFormatUtil.getDateTimeFormat().format(dive.getDate());
