...
public class GasOverflowEditWindow extends JDialog {
   ...
   private void initialize() {
      setIconImage(Toolkit.getDefaultToolkit()
            .getImage(getClass().getResource("/net/sf/jdivelog/gui/resources/icons/logo.gif")));
   ...
   private void load() {
      if (source == null) {
         ...
         getTankSize().setText(Double.valueOf(source.getTanksize()).toString());
         getTankPressure().setText(Double.valueOf(source.getTankpressure()).toString());
      }
   }
   ...
   private boolean save() {
      try {
         ...
         s.setTankpressure(Double.valueOf(getTankPressure().getText()));
         s.setTanksize(Double.valueOf(getTankSize().getText()));
         if (source == null) {
         ...
         new MessageDialog(this.mainWindow, Messages.getString("mixing.input_error"), //$NON-NLS-1$
               Messages.getString("mixing.not_a_number"), null, MessageDialog.MessageType.ERROR); //$NON-NLS-1$
         return false;
      }
      return true;
   }
