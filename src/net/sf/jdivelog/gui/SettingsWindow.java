...
public class SettingsWindow extends JDialog implements TreeSelectionListener, ActionListener {
   ...
   private TreeNode getRootNode() {
      if (rootNode == null) {
         ...
         DefaultMutableTreeNode export = appendNode(rootNode, "configuration.export",
               new ExportSettingsGeneralPanel(mainWindow));
   ...
   private DefaultMutableTreeNode appendNode(DefaultMutableTreeNode parentNode, String name,
