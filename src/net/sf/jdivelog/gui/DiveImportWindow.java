...
/**
 * Description: window for loading dump files
 * 
 * @author Andr&eacute; Schenk
 * @version $Revision: 1035 $
 */
public class DiveImportWindow extends DiveImportDataTrakWindow {
    private static final long serialVersionUID = -5438951890127414354L;

    public DiveImportWindow(MainWindow mainWindow,
        ArrayList<JDive> divesToAdd, String title) {
