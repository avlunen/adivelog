...
public class ExportSettingsLayoutPanel extends AbstractSettingsPanel implements ActionListener {
   ...
   public void load() {
      ...
      JComboBox<String> skf = getSkinField();
      if(skf != null) skf.setSelectedItem(currentSkin);
   }
   ...
   public void actionPerformed(ActionEvent e) {
      if (e.getSource() == getChooseSkinFileButton()) {
         ...
         if (ret == JFileChooser.APPROVE_OPTION) {
            ...
            assertItemExists(fn);
            JComboBox<String> skf = getSkinField();
            if(skf != null) skf.setSelectedItem(fn);
         }
      }
   }
   ...
   private JComboBox<String> getSkinField() {
      if (skinField == null) {
         ...
         String skindir = System.getProperty("export.skindir");
         if (skindir == null) {
            new MessageDialog(mainWindow, Messages.getString("export.error.skindir_property_not_set"), null, null,
            ...
            if (!sd.exists() || !sd.isDirectory() || !sd.canRead()) {
               new MessageDialog(mainWindow, Messages.getString("export.error.skindir_is_not_readable"), null, null,
                     MessageDialog.MessageType.INFO);
            }
            else {
               ...
               ff.addExtension("zip");
               File[] files = skinfile.listFiles(ff);
         ...
         skinField = new JComboBox<String>(skins);
      }
      return skinField;
   }
   ...
   private void assertItemExists(String item) {
      ...
      int itemCount = skf.getItemCount();
