...
public class JavaCommSerialPort implements SerialPort {
    ...
    public void enableReceiveThreshold(int thresh) throws UnsupportedCommOperationException {
        try {
            delegate.enableReceiveThreshold(thresh);
        } catch (javax.comm.UnsupportedCommOperationException e) {
            throw new UnsupportedCommOperationException(e);
        }
    }
    ...
    public void setFlowControlMode(FlowControlMode flowcontrol) throws UnsupportedCommOperationException {
        try {
            delegate.setFlowControlMode(getFlowControlMode(flowcontrol));
        } catch (javax.comm.UnsupportedCommOperationException e) {
            throw new UnsupportedCommOperationException(e);
        }
    }
    ...
    private int getFlowControlMode(FlowControlMode flowcontrol) {
        if (flowcontrol == FlowControlMode.FLOWCONTROL_NONE) {
            return (javax.comm.SerialPort.FLOWCONTROL_NONE);
        } else if (flowcontrol == FlowControlMode.FLOWCONTROL_RTSCTS_IN) {
            return (javax.comm.SerialPort.FLOWCONTROL_RTSCTS_IN);
        } else if (flowcontrol == FlowControlMode.FLOWCONTROL_RTSCTS_OUT) {
            return (javax.comm.SerialPort.FLOWCONTROL_RTSCTS_OUT);
        } else if (flowcontrol == FlowControlMode.FLOWCONTROL_XONXOFF_IN) {
            return (javax.comm.SerialPort.FLOWCONTROL_XONXOFF_IN);
        } else if (flowcontrol == FlowControlMode.FLOWCONTROL_XONXOFF_OUT) {
            return (javax.comm.SerialPort.FLOWCONTROL_XONXOFF_OUT);
        }
        throw new RuntimeException("flow control mode not supported " + flowcontrol);
    }
