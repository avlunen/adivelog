...
public class PrinterOutputDevice implements OutputDevice {
    ...
    private String[] getMimeTypes() {
        String[] mimeTypes = new String[] { MimeConstants.MIME_POSTSCRIPT, MimeConstants.MIME_PCL, MimeConstants.MIME_PCL_ALT, MimeConstants.MIME_PDF , MimeConstants.MIME_PNG};
        return mimeTypes;
    }
