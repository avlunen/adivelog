...
<xsl:param name="margin-page-right">10mm 7mm 18mm 18mm</xsl:param>
<xsl:param name="margin-page-left">10mm 7mm 18mm 18mm</xsl:param>
<xsl:param name="margin-body-right">10mm 7mm 18mm 18mm</xsl:param>
<xsl:param name="margin-body-left">10mm 7mm 18mm 18mm</xsl:param>
			...
			<fo:flow flow-name="xsl-region-body">
				<fo:block font-family="{$font-family}" font-size="{$font-size-text}" color="rgb(0,128,128)">
					<fo:table table-layout="fixed" width="100%">
						...
						<fo:table-column column-width="12mm"/>
						<fo:table-header color="white">
							<fo:table-row background-color="rgb(0,128,128)" color="rgb(255,255,255)">
							<fo:table-cell>
							...
							<fo:table-cell>
								<fo:block><xsl:value-of select="java:net.sf.jdivelog.gui.resources.Messages.getString('country')"/></fo:block>
							</fo:table-cell>
							<fo:table-cell>
...
<xsl:template match="JDiveLog/JDive">
	...
	<xsl:choose>
	<xsl:when test="position() mod 35 = 0">
		<xsl:variable name="file"
					select="java:net.sf.jdivelog.printing.report.ImageUtil.getNextImage()" />
