...
/**
 * Driver for the "Open Source Tauchcomputer" of HeinrichsWeikamp. OSTC @link
 * http://www.heinrichsweikamp.net/ostc/en/index.htm
 * 
 * @author Pascal Pellmont <jdivelog@pellmont.dyndns.org>
 */
public class OSTCInterface implements ComputerInterface {
    ...
    private static final String[] DRIVER_CLASS_NAMES = { "net.sf.jdivelog.ci.ostc.OSTCProtocol070511",
            "net.sf.jdivelog.ci.ostc.OSTCProtocol080115", "net.sf.jdivelog.ci.ostc.OSTCProtocol080121",
            "net.sf.jdivelog.ci.ostc.OSTCProtocol080321", "net.sf.jdivelog.ci.ostc.OSTCProtocol081130",
            "net.sf.jdivelog.ci.ostc.OSTCProtocol100801", "net.sf.jdivelog.ci.ostc.OSTCProtocol100801Mk2",
            "net.sf.jdivelog.ci.ostc.OSTCProtocol110119Mk2", "net.sf.jdivelog.ci.ostc.OSTCProtocol110523Mk2",
            "net.sf.jdivelog.ci.ostc.OSTCProtocol110615Mk2" };
    ...
    static {
        drivers = new LinkedHashMap<String, AbstractOSTCProtocol>();
    ...
    public static AbstractOSTCProtocol getDriver(String driverName) {
    ...
    /**
     * Get the OSTC protocol the user has chosen.
     * 
     * @return OSTC protocol
     */
    public AbstractOSTCProtocol getProtocol() {
        return drivers.get(getProtocolName());
    }

    /**
     * Get the OSTC protocol name the user has chosen.
     * 
     * @return OSTC protocol name
     */
    private String getProtocolName() {
        String result = null;

        if (properties != null) {
            result = properties.getProperty(PROPERTY_NAMES[1]);
        }
        return result;
    }
    ...
    public void initialize(Properties properties) {
        ...
        getConfigurationPanel().setProtocol(getProtocolName());
    }

    public void transferSettings(StatusInterface statusInterface) throws TransferException, NotInitializedException,
            InvalidConfigurationException {
        if (properties == null) {
            throw new NotInitializedException();
        }
        String protocolName = getProtocolName();
        if (protocolName == null || "".equals(protocolName) || getDriver(protocolName) == null) {
    ...
    /**
     * @see net.sf.jdivelog.ci.ComputerInterface#transfer(net.sf.jdivelog.gui.statusbar.StatusInterface,
     *      JDiveLog)
     */
    public void transfer(StatusInterface statusInterface, JDiveLog logbook) throws TransferException,
            NotInitializedException, InvalidConfigurationException {
        if (properties == null) {
            throw new NotInitializedException();
        }
        String protocolName = getProtocolName();
    ...
    public void setTime(StatusInterface status, long millis) throws NotInitializedException, TransferException,
            InvalidConfigurationException {
        String protocolName = getProtocolName();
        if (protocolName == null || "".equals(protocolName) || getDriver(protocolName) == null) {
    ...
    public void resetDecoInformation(StatusInterface status) throws NotInitializedException, TransferException,
            InvalidConfigurationException {
        String protocolName = getProtocolName();
        if (protocolName == null || "".equals(protocolName) || getDriver(protocolName) == null) {
            protocolName = detectDriverName(status);
    ...
    public void stopDiveMode(StatusInterface status) throws InvalidConfigurationException {
        ...
        try {
            ...
            commPort.setSerialPortParams(115200, SerialPort.DataBits.DataBits_8, SerialPort.Parity.NONE,
                    SerialPort.StopBits.StopBits_1);
    ...
    private String detectDriverName(StatusInterface status) throws InvalidConfigurationException {
        ...
        try {
            ...
            if (drivername == null) {
                drivername = getDriverNameByFirmwareVersion(hashbuf[0], hashbuf[1]);
            }
            if (drivername == null) {
    ...
    public static String getDriverNameByFirmwareVersion(int highByte, int lowByte) {
        String result = null;
        int version = VersionRange.getVersion(highByte, lowByte);

        for (AbstractOSTCProtocol protocol : drivers.values()) {
            if (protocol.getFirmwareVersions().isInRange(version)) {
    ...
    private class OSTCSimulatorImpl implements OstcSimulator {
        ...
        public void initialize() throws InvalidConfigurationException, PortNotFoundException, PortInUseException,
