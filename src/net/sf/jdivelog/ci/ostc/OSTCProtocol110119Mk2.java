...
public class OSTCProtocol110119Mk2 extends OSTCProtocol100801Mk2 {
    ...
    private static final VersionRange FIRMWARE_VERSIONS = new VersionRange(VersionRange.getVersion("1.80"),
            VersionRange.getVersion("1.89"));
    private static final String[] HASHKEYS = new String[] {};

    protected static final Feature CF49MK2 = new Feature("ostc_cf49mk2", RadioButtonValue.class); // Show
                                                                                                  // Altimeter
    protected static final Feature CF50MK2 = new Feature("ostc_cf50mk2", RadioButtonValue.class); // Show
                                                                                                  // Log
                                                                                                  // Marker
    protected static final Feature CF51MK2 = new Feature("ostc_cf51mk2", RadioButtonValue.class); // Show
                                                                                                  // Stopwatch
    protected static final Feature CF52MK2 = new Feature("ostc_cf52mk2", RadioButtonValue.class); // Show
                                                                                                  // Tissuegraph
    protected static final Feature CF53MK2 = new Feature("ostc_cf53mk2", RadioButtonValue.class); // Show
                                                                                                  // Leading
                                                                                                  // Tissue
    ...
    private static final Feature[] ALL_FEATURES = { SERIALNUMBER, TOTALDIVES, GAS1, GAS1DEFAULT, GAS2, GAS2DEFAULT,
            ...
            CF48MK2, CF49MK2, CF50MK2, CF51MK2, CF52MK2, CF53MK2, CUSTOM_TEXT };
    ...
    protected Map<Feature, OSTCValue> parseSettings2(byte[] data) {
        ...
        result.put(CF49MK2, new RadioButtonValue(cur, def, new int[] { 0, 1 }, new String[] { "ostc_cf42_noblink",
                "ostc_cf42_blink" }));

        offset += 4;
        def = ParseUtil.parseCFValue(data, offset);
        cur = ParseUtil.parseCFValue(data, offset + 2);
        result.put(CF50MK2, new RadioButtonValue(cur, def, new int[] { 0, 1 }, new String[] { "ostc_cf42_noblink",
                "ostc_cf42_blink" }));

        offset += 4;
        def = ParseUtil.parseCFValue(data, offset);
        cur = ParseUtil.parseCFValue(data, offset + 2);
        result.put(CF51MK2, new RadioButtonValue(cur, def, new int[] { 0, 1 }, new String[] { "ostc_cf42_noblink",
                "ostc_cf42_blink" }));

        offset += 4;
        def = ParseUtil.parseCFValue(data, offset);
        cur = ParseUtil.parseCFValue(data, offset + 2);
        result.put(CF52MK2, new RadioButtonValue(cur, def, new int[] { 0, 1 }, new String[] { "ostc_cf42_noblink",
                "ostc_cf42_blink" }));

        offset += 4;
        def = ParseUtil.parseCFValue(data, offset);
        cur = ParseUtil.parseCFValue(data, offset + 2);
        result.put(CF53MK2, new RadioButtonValue(cur, def, new int[] { 0, 1 }, new String[] { "ostc_cf42_noblink",
                "ostc_cf42_blink" }));
