 ...
 * @author Pascal Pellmont <jdivelog@pellmont.dyndns.org>
 */
public class OSTCProtocol100801 extends OSTCProtocol081130 {

    private static final Logger LOGGER = Logger.getLogger(OSTCProtocol100801.class.getName());
    ...
    protected static final Feature CF42 = new Feature("ostc_cf42", RadioButtonValue.class); // Notify
                                                                                            // Gas
                                                                                            // Change
    ...
    private static final Feature[] ALL_FEATURES = { SERIALNUMBER, TOTALDIVES, GAS1, GAS1DEFAULT, GAS2, GAS2DEFAULT,
            ...
            CF37, CF38, CF39, CF40, CF41, CF42, CUSTOM_TEXT };
