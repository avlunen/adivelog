 ...
 * and a function to read only EEPROM values rather than the whole profile
 * memory.
 * 
 * @author Pascal Pellmont <jdivelog@pellmont.dyndns.org>
 */
public class OSTCProtocol080115 extends AbstractOSTCProtocol {
    ...
    private static final VersionRange FIRMWARE_VERSIONS = new VersionRange(VersionRange.getVersion("1.1"),
            VersionRange.getVersion("1.2"));
    private static final String[] HASHKEYS = new String[] { "2bcb9bbf90c1706f8582ad3dc52356fb",
            "0bc36972586a4c2e887173ea9f906a02" };

    private static final Feature SERIALNUMBER = new Feature("suuntoConfigurationPanel.serialNumber",
            ReadonlyInteger.class);
    private static final Feature TOTALDIVES = new Feature("suuntoConfigurationPanel.numberOfDives",
            ReadonlyInteger.class);
    ...
    private static final Feature[] ALL_FEATURES = { SERIALNUMBER, TOTALDIVES, GAS1CURRENT, GAS1DEFAULT, GAS2CURRENT,
            GAS2DEFAULT, GAS3CURRENT, GAS3DEFAULT, GAS4CURRENT, GAS4DEFAULT, GAS5CURRENT, GAS5DEFAULT, CF00, CF01,
            CF02, CF03, CF04, CF05, CF06, CF07, CF08, CF09, CF10, CF11, CF12, CF13, CF14, CF15, CF16, CF17, CF18, CF19 };
   ...
   static JDive createDive(byte[] data) {
        ...
        if (!(data[data.length - 2] == ParseUtil.toByte(0xfd) && data[data.length - 1] == ParseUtil.toByte(0xfd))) {
            LOGGER.severe("invalid profile header end " + Hexadecimal.valueOf(data[data.length - 2])
