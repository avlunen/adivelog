...
public class OSTCProtocol080321 extends OSTCProtocol080121 {
    ...
    private static final VersionRange FIRMWARE_VERSIONS = new VersionRange(VersionRange.getVersion("1.9"),
            VersionRange.getVersion("1.17"));
    private static final String[] HASHKEYS = new String[] { "eaecf0b886678e2f6d07314edeb868e3",
            "6c5fcbd4e4eb1704b1a9860dedbe8c5e", "c2c1e944d7eda6c2dcf8d84c53796b87", "e5ed5b4ecb9b8b71e12ba0b2be2e05e3",
            "6e9ceb6113d407255b0a1eb3dfc564d6", "8f1f09d4f3d389dd54fdf305f99fd208", "6ede3075814b7b31633fc3f090e4246d" };
    ...
    private static final Feature[] ALL_FEATURES = { SERIALNUMBER, TOTALDIVES, GAS1, GAS1DEFAULT, GAS2, GAS2DEFAULT,
            GAS3, GAS3DEFAULT, GAS4, GAS4DEFAULT, GAS5, GAS5DEFAULT, GAS6CURRENT, STARTGAS, DECOTYPE, CF00, CF01, CF02,
            CF03, CF04, CF05, CF06, CF07, CF08, CF09, CF10, CF11, CF12, CF13, CF14, CF15, CF16, CF17, CF18, CF19, CF20,
            CF21, CF22, CF23, CF24, CF25, CF26, CF27, CF28, CF29, CF30, CUSTOM_TEXT };
    ...
    protected Map<Feature, OSTCValue> parseSettings(byte[] data) {
        ...
        result.put(DECOTYPE, new RadioButtonValue(decotype, 0, new int[] { 0, 1, 2, 3 }, new String[] {
                "ostc_deco_zhl16", "ostc_deco_gauge", "ostc_deco_const_ppo2", "ostc_deco_apnoe" }));
