...
public class OSTCProtocol081130 extends OSTCProtocol080321 {
    ...
    private static final VersionRange FIRMWARE_VERSIONS = new VersionRange(VersionRange.getVersion("1.19"),
            VersionRange.getVersion("1.44"));
    private static final String[] HASHKEYS = new String[] { "114f881dd49028b941471c48773c6dd3",
            "5824997748994b3aa4e4e3108b60245f", "58f1997ac2125eadfbb30703c6107e34", "b17229f06430395cc7a90faf2469be42" };

    protected static final Feature CF31 = new Feature("ostc_cf31", RadioButtonValue.class); // Battery
                                                                                            // Display
    ...
    protected static final Feature CF34 = new Feature("ostc_cf34", EightBitCustomFunction.class); // HUD
                                                                                                  // low
                                                                                                  // PPO2
                                                                                                  // Warn
                                                                                                  // Level
    ...
    protected static final Feature CF37 = new Feature("ostc_cf37", RadioButtonValue.class); // HUD
                                                                                            // Style
    protected static final Feature CF38 = new Feature("ostc_cf38", RadioButtonValue.class); // Time
                                                                                            // Format
    protected static final Feature CF39 = new Feature("ostc_cf39", RadioButtonValue.class); // Flip
                                                                                            // Display
    protected static final Feature CF40 = new Feature("ostc_cf40", RadioButtonValue.class); // Use
                                                                                            // big
                                                                                            // ppO2
    protected static final Feature CF41 = new Feature("ostc_cf41", RadioButtonValue.class); // Show
                                                                                            // Avg
                                                                                            // Depth
    ...
    private static final Feature[] ALL_FEATURES = { SERIALNUMBER, TOTALDIVES, GAS1, GAS1DEFAULT, GAS2, GAS2DEFAULT,
            ...
            CF19, CF20, CF21, CF22, CF23, CF24, CF25, CF26, CF27, CF28, CF29, CF30, CF31, CF32, CF33, CF34, CF35, CF36,
            CF37, CF38, CF39, CF40, CF41, CUSTOM_TEXT };
    ...
    @Override
    public void upload(StatusInterface status) throws NotInitializedException, PortNotFoundException,
            PortInUseException, UnsupportedCommOperationException, IOException, TransferException {
        super.upload(status);
        store2(data, eeprom2);
        ...
        try {
            ...
            for (int i = 0; i < eeprom2.length; i++) {
                ...
                if (len != 1 || res[0] != buf[0]) {
                    LOGGER.severe("Timeout on byte " + i + " len=" + len + " res[0]=" + Hexadecimal.valueOf(res[0])
                            + ", read-time=" + (System.currentTimeMillis() - start));
    ...
    protected Map<Feature, OSTCValue> parseSettings2(byte[] data) {
        ...
        def = ParseUtil.parseCFValue(data, offset);
        cur = ParseUtil.parseCFValue(data, offset + 2);
        result.put(CF37, new RadioButtonValue(cur, def, new int[] { 0, 1, 2, 3 }, new String[] { "ostc_cf37_ostc",
                "ostc_cf37_ds1", "ostc_cf37_rgb", "ostc_cf37_smithers" }));
        ...
        def = ParseUtil.parseCFValue(data, offset);
        cur = ParseUtil.parseCFValue(data, offset + 2);
        result.put(CF39, new RadioButtonValue(cur, def, new int[] { 0, 1 }, new String[] { "ostc_cf39_normal",
                "ostc_cf39_flip" }));

        offset += 4;
        def = ParseUtil.parseCFValue(data, offset);
        cur = ParseUtil.parseCFValue(data, offset + 2);
        result.put(CF40, new RadioButtonValue(cur, def, new int[] { 0, 1 }, new String[] { "ostc_cf40_normal",
                "ostc_cf40_big" }));

        offset += 4;
        def = ParseUtil.parseCFValue(data, offset);
        cur = ParseUtil.parseCFValue(data, offset + 2);
        result.put(CF41, new RadioButtonValue(cur, def, new int[] { 0, 1 }, new String[] { "ostc_cf41_temperature",
                "ostc_cf41_avgdepth" }));
        return result;
    }
