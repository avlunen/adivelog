...
public class DriverManager {
    ...
    private static final Logger LOGGER = Logger.getLogger(DriverManager.class
            .getName());
    private static String[] DRIVERCLASSES = {
            "net.sf.jdivelog.ci.SuuntoInterface",
            "net.sf.jdivelog.ci.SuuntoNGInterface",
            "net.sf.jdivelog.ci.AladinInterface",
            "net.sf.jdivelog.ci.OSTCInterface",
            "net.sf.jdivelog.ci.SmartInterface",
            "net.sf.jdivelog.ci.DR5UddfInterface",
            "net.sf.jdivelog.ci.MemoMouseInterface",
            "net.sf.jdivelog.ci.SRIPredatorInterface"};
    ...
    private void addDriver(String className) {
        try {
            ...
            LOGGER.log(Level.SEVERE, "Could not instantiate driver '"
                    + className + "'", t);
        }
    }
